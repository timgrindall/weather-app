...
This app was created to learn React.js and is my second project with the library (not including tutorials and a book). The app pulls weather data from OpenWeatherMap.org using the free tier of the 5-day, 3-hour forecast.
